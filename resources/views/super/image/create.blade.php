            ...
            <div class="col-md-12">
                <div class="card bg-transparent border-0 text-white">
                    <div class="card-body">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-md-4">
                                <small class="text-justify-center d-sm-block d-none">
                                    <ul class="list-group">
                                ...
                                <small class="text-center d-sm-block d-md-none">
                                    <ul class="list-group">
                                        <li class="list-group-item bg-transparent border-0">
                                            <p>Username: {{ auth()->user()->name }}</p>
                                        </li>
                ...
                <div class="card">
                    <div class="text-white card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="btn-group">
                            <a href="{{ url('/super/profile?option=albums') }}" class="btn btn-dark btn-sm"><i
                                    class="fas fa-arrow-left"></i></a>
                            <a href="{{ route('album.content', $album->id) }}" class="btn btn-dark btn-sm"><i
                    ...
                    <div class="card-body">
                        ...
                        <div class="alert alert-warning alert-dismissible" id="dropzoneMessageProblem"
                            style="display: none">
                            <button type="button" class="close" data-dismiss="alert">&times;</button>
                        ...
                        <div class="text-center">
                            <div class="container-fluid" style="padding: 0px;">
                                <div class="form-container">
                                    <form action="{{ route('super.image.store') }}" method="POST" class="dropzone"
                                        id="mydropzone">
