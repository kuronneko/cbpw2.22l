    ...
    <div class="row" id="albumsBox">
        ...
        <div class="card bg-dark text-white indexCard mb-4">
            ...
            <div class="photos" wire:ignore>
                ...
                @if ($image->ext == "mp4" || $image->ext == "webm")
                <img src="{{'/cbpw2.22l/public/storage/images/videothumb.png'}}" class="imgThumbPublicIndex masonry" data-was-processed='true' wire:ignore>
                @else
                <img src="{{'/cbpw2.22l/public/'}}{{ $image->url }}_thumb.{{$image->ext}}" class="imgThumbPublicIndex masonry" data-was-processed='true' wire:ignore>
                @endif
                @endif
                @endif
                @endforeach
