...
<div class="text-center">
    ...
    <div class="row" id="albumsBox">
        ...
        <div class="card text-white indexCard mb-4">
            ...
            <strong><p class="cardAlbumTittle upperCaseTittles text-danger">{{$album->name}}</p></strong><p class="cardAlbumTittle lowerCaseTittles text-secondary">By: {{$album->user->name}}</p>
            </div>
