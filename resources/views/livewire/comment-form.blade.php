    ...
    <div class="row">
        ...
        <div class="col-11 col-md-11">
           ...
           <div class="form-group">
            ...
            <textarea rows="1" placeholder="Maximum length: 150 characters" maxlength="150" type="text" class="form-control bg-comments text-white border-dark" wire:model="text"></textarea>
            </div>
           @else
           <div class="form-group">
            <input type="hidden" />
            <textarea rows="1" placeholder="Only registered users can post" maxlength="150" type="text" class="form-control bg-comments text-white border-dark" disabled></textarea>
            </div>
           @endif
        </div>
    </div>
